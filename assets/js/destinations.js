...
jQuery(function() {
    for (let i = 0; i < destinations.length; i++) {
        if (destinations[i]['img']) {
            ...
            $(read).attr("href", destinations[i]['read']);
